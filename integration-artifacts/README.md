...
| --- | --- | --- | --- |
| SAP Ariba | This flow supports integration with [SAP Ariba Audit Search API](https://api.sap.com/api/audit_search_v2/overview) to extract audit logs for Sentinel ingestion.| 🔗[link](solution-packages/baseline-extension-package/) | [MartinPankraz](https://github.com/MartinPankraz/) |
